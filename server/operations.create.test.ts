...
describe("createOrder", () => {
  ...
  it("aplica o valor total do pedido ao payload PIX compatível", async () => {
    const created = { id: 42, ticket: 8, requestKey: "pedido-pix-valor", status: "NEW", paymentMethod: "PIX", total: "12.50", note: null, createdAt: new Date(), updatedAt: new Date() };
    const product = { id: 7, name: "Lanche configurado", price: "12.50", available: true, category: "Lanches", description: null, sortOrder: 0, createdAt: new Date(), updatedAt: new Date() };
  ...
  it("usa o valor fixo configurado quando o total da comanda está desativado", async () => {
    const created = { id: 42, ticket: 8, requestKey: "pedido-pix-fixo", status: "NEW", paymentMethod: "PIX", total: "12.50", note: null, createdAt: new Date(), updatedAt: new Date() };
    const product = { id: 7, name: "Lanche configurado", price: "12.50", available: true, category: "Lanches", description: null, sortOrder: 0, createdAt: new Date(), updatedAt: new Date() };
    const pixPayload = "00020101021226260014br.gov.bcb.pix0104test5204000053039865802BR5903ABC6003RIO62070503***6304ABCD";
    const inserted: InsertCall[] = [];
